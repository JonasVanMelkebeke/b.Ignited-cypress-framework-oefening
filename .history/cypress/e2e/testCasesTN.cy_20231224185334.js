...
describe('Test Cases Telefoon nummers', () => {
    ...
    it('[Telefoon nummers] Verify selected country returns correct area code - Default amount returns only 1 number', () => {
      const testDataGeneratorObj = new testDataGenerator();

      const country = ''
      testDataGeneratorObj.telefoonNummersDropdownClick();
      testDataGeneratorObj.telephoneNumberCountrySelect(Belgium)
    })
   })