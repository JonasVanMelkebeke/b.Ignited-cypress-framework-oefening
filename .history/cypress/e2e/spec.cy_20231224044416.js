...
describe('POM Test', () => {
  ...
  it('[Telefoon N]Verify Dropdown Menu "Telefoon Nummers" is visible after clicking', () => {
    const testDataGeneratorObj = new testDataGenerator();
  ...
  it('[Telefoon N]Verify more info is shown when "More Info" is pressed in Telefoon nummers', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.telefoonNummersDropdownClick();
