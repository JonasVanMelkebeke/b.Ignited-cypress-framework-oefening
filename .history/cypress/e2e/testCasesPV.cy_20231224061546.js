...
describe('Test Cases Proces Verbaal nummers', () => {
  ...
  it('[Proces Verbaal nummers] Verify functionality of button generate with amount 2', () => {
    const testDataGeneratorObj = new testDataGenerator();
    ...
    testDataGeneratorObj.pvGeneratedNumbersTxt.should('include', (expectedSuffix * expectedReturnedNumbers)
  })
 })