...
describe('POM Test', () => {
  ...
  it('[Proces Verbaal nummers] Verify Dropdown Menu "Proces Verbaal nummers" is visible after clicking', () => {
  ...
  it('[Proces Verbaal nummers] Verify more info is shown when "More Info" is pressed in Proces Verbaal', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.procesVerbaalDropdownClick();
  ...
  it('[Proces Verbaal nummers] Verify if the text in more info contains "The complexity and inconsistency of the Belgian Proces Verbaal"', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.procesVerbaalDropdownClick();
    testDataGeneratorObj.pvMoreInfoClick();
