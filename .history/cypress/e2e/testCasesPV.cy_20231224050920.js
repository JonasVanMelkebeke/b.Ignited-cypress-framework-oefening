...
describe('Test Cases Proces Verbaal nummers', () => {
  ...
  it('Verify Input Field Proces Verbaal', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.procesVerbaalDropdownClick();
    testDataGeneratorObj.pvInput.type('42'); // Type a value into the input field
    testDataGeneratorObj.pvInput.should('have.value', '42'); // Verify the entered value
  })
 })