...
describe('POM Test', () => {
  ...
  it('[Telefoon numm]Verify Dropdown Menu "Telefoon Nummers" is visible after clicking', () => {
    const testDataGeneratorObj = new testDataGenerator();
  ...
  it('[Telefoon numm]Verify more info is shown when "More Info" is pressed in Telefoon nummers', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.telefoonNummersDropdownClick();
