...
describe('POM Test', () => {
  ...
  it('[Proce]Verify Dropdown Menu "Proces Verbaal" is visible after clicking', () => {
  ...
  it('[Proce]Verify more info is shown when "More Info" is pressed in Proces Verbaal', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.procesVerbaalDropdownClick();
  ...
  it('[Proce]Verify if the text in more info contains "The complexity and inconsistency of the Belgian Proces Verbaal"', () => {
    const testDataGeneratorObj = new testDataGenerator();
    testDataGeneratorObj.procesVerbaalDropdownClick();
    testDataGeneratorObj.pvMoreInfoClick();
