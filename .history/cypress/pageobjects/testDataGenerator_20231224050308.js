class testDataGenerator {
    elements = {
        procesVerbaalDropdownBtn: () => cy.get('.accordion-button:contains("Proces Verbaal nummers")'),
        telefoonNummersDropdownBtn: () => cy.get('.accordion-button:contains("Telefoon nummers")'),
